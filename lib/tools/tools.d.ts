...
export declare let _alemNavigateFactory: (
  // Funcao usada no Rout para receber o "navigate" e passar para o "_alemNavigateMethod"
  navigateMethod: (route: string) => void,
) => void;
// Método usado para navegar nas rotas (isso é compartilhado com escopo global)
declare const navigate: (route: string) => void;
// Usado para guardar o route type
export declare let _alemRouteType: "URLBased" | "ContentBased";
// Nome do parametro a ser reconhecido como verificador de rota
export declare let _alemRouteParameterName: string;
// URL Params (BOS Props): propriedades do alem (widget principal)
export declare let _alemProps: Record<string, string>;
// Usado para armazenar as rotas
export declare let _alemRoutes: string[];
