...
const replaceItemNamesInOtherFilesContent = (
  ...
  fileSchemas.forEach((fileSchema, fileSchemaIndex) => {
    ...
    if (fileSchema.toImport.includes(contentFilePath)) {
      ...
      // console.log("AAAAAAAA", fileSchemaContent, replaceItemRegexp, fileSchema);
      fileSchemaContent = fileSchemaContent.replaceAll(
        replaceItemRegexp,
        newItemName,
      );

      // console.log("BBBBBBBB", fileSchemaContent);

      // Seta novo valor
      // console.log("AAAAAAAA", fileSchemas[fileSchemaIndex].content);
      fileSchemas[fileSchemaIndex].content = fileSchemaContent;
      // console.log("BBBBBBBBB", fileSchemas[fileSchemaIndex].content);
    }
  });
...
const handleNames = (fileSchemas) => {
  ...
  itemsToProcess.forEach((itemKey) => {
    ...
    exportsOrganizer[itemKey].forEach((exportObj, objIndex) => {
      ...
      if (checkIfItemExistInContent(tempBundle, exportKeyName)) {
        ...
        // console.log("CHANGED FILE CONTENT:", fileContent);
        fileSchemas = result.fileSchemas;
        // console.log(itemKey);
        // console.log(result.fileSchemas.filter((v) => v.filePath === itemKey));

        // console.log("SCHEMAAAAA ALTERADO", result.fileSchemas);
        // console.log("A");
  ...
  // console.log("SCHEMAAAAA ALTERADO", fileSchemas);
