...
const processSchema = (fileSchema) => {
  ...
  if (fileSchema.filePath.includes("/Router.tsx")) {
    console.log(jsContent);
  }
  ...
  if (!isModule) {
    console.log(analyzeFunctionSignature(fileSchema.pureJsContent));
...
const populateHtmlElementsProps = (fileSchema) => {
  ...
  // TODO: Acho que "htmlElementProps" não está sendo usado!!!
    ...
    if (importItemFilePath && !pastedFiles.includes(importItemFilePath)) {
      ...
      if (isImportItemCommingFromJsxFile) {
        ...
        if (importItemFileSource) {
          ...
          // console.log("CHECK WIDGET NAME:", !!importItemWidget);
          // console.log("CHECK A:", importItemFileSource);
          // console.log("CHECK B:", importItem);
...
const prepareListOfInjections = (fileSchemas, fileSchema) => {
  ...
  Object.keys(fileSchema.componentImportItems).forEach((importItem) => {
    ...
    if (importItemFileSource && !pastedFiles.includes(importItemFileSource)) {
      ...
      // console.log("====== CHECAGEM DE INJECAO ======  ");
      // console.log("Arquivo sendo processado:", fileSchema.filePath);
      // console.log("Arquivo sendo injetado:", importItemFileContent.filePath);
      // console.log(
      //   "Arquivo sendo injetado está pronto?",
      ...
      if (importItemFileContent.isModule) {
        // console.log(fileSchema.filePath);
        // console.log("componentImportItems ===>", importItemFileSource);
        // console.log("Esquema da dependencia:", importItemFileContent);
        // console.log("\n");
        ...
        if (!importItemFileContent.injectFilesDependencies_Done) {
          // console.log(
          //   "!!!!!Arquivo sendo injetado não está pronto! Usando recursividade!!!!!!",
          // );
          ...
          // console.log(
          //   "Arquivo sendo injetado está pronto? [após recursividade?]",
          //   importItemFileContent.injectFilesDependencies_Done,
          // );
        }
...
const injectFilesDependencies = (fileSchemas, fileSchema) => {
  ...
  console.log("====== CHECAGEM DE INJECAO ======  ");
  console.log("Arquivo sendo processado:", fileSchema.filePath);
  console.log("Para ser Injetado:", fileSchema.toBeInjectedFiles);
...
const transformSchemaToWidget = (fileSchemas, additionalFileSchemas) => {
  ...
  //   // Remover comentarios
  //   fileSchema.content = removeCommentsFromJSX(jsContent);

  //   if (fileSchema.filePath.includes("Footer")) {
  //     console.log("FILE - PRINNNT :", fileSchema.filePath);
  ...
  // TODO: htmlElementsProps nao esta sendo utilizado
  // fileSchemas.forEach((fileSchema, fileSchemaIndex) => {
