      ...
      if (isImportItemCommingFromJsxFile) {
        ...
        if (importItemFileSource) {
          ...
          if (importItemWidgetComponentName && !importItemWidget.isModule) {
            ...
            if (fileSchema.filePath.includes("FundingRaised.tsx")) {
              console.log(
                "fileSchema.content",
                fileSchema.content,
                "importItemWidgetComponentName",
            ...
            if (fileSchema.filePath.includes("FundingRaised.tsx")) {
              console.log(
                "AAAA - importItemWidgetComponentName: ",
                importItemWidgetComponentName,
              );
              console.log("\n\n");
            }
            ...
            if (fileSchema.filePath.includes("FundingRaised.tsx")) {
              console.log(
                "AAAA 2 - importItemWidgetComponentName: ",
                importItemWidgetComponentName,
              );
              console.log("\n\n");
            }
            ...
            componentElements.elements.forEach((div, divIndex) => {
              if (fileSchema.filePath.includes("FundingRaised.tsx")) {
                console.log(
                  "AAAA INFO - importItemWidgetComponentName: ",
                  importItemWidgetComponentName,
                  "div",
                  div,
                  "divIndex",
              ...
              if (fileSchema.filePath.includes("FundingRaised.tsx")) {
                console.log(
                  "AAAA 3 - importItemWidgetComponentName: ",
                  importItemWidgetComponentName,
                );
                console.log("\n\n");
              }

              if (fileSchema.filePath.includes("Body.tsx")) {
                console.log("htmlElementString: ", htmlElementString);
                console.log("\n\n");
                console.log("======= TESTE DO MALACDO PROPS =======");
                console.log(importItemFilePath);
                console.log(childProps);
                console.log(childSpreads);
                // console.log(["{...foo}", "{...foaao}"].join(" "));
                console.log("\n\n");
              }
              ...
              if (fileSchema.filePath.includes("FundingRaised.tsx")) {
                console.log(
                  "BBBB - importItemWidgetComponentName: ",
                  importItemWidgetComponentName,
                  "fileBundle:",
                  fileBundle,
                );
              ...
              if (fileSchema.filePath.includes("FundingRaised.tsx")) {
                console.log(
                  "CCCC - importItemWidgetComponentName: ",
                  importItemWidgetComponentName,
                  "fileBundle:",
                  fileBundle,
                );
