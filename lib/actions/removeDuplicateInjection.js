...
const removeDuplicateInjection = (
  ...
  Object.keys(itemsToRemove).forEach((filePath) => {
    ...
    if (fileSchema.filePath === "src/components/Sidebar/index.tsx") {
      console.log("PRELUDIO:");
      console.log(1, conflictedContent);
      console.log(2, filePath);
      console.log("FIM PRELUDIO:");
    }
    ...
    for (let i = itemsToRemove[filePath]; i > 0; i--) {
      ...
      if (
        ...
        if (fileSchema.filePath === "src/components/Sidebar/index.tsx") {
          console.log("BUNDLE:", "é o sidebar");
          console.log("Current File Bundle Content:");
          console.log(currentFileBundleContent.trim());
          console.log("\n");
          console.log("Conflicted Content");
          console.log(conflictedContent);
        }

        log.error(
          "Error removing duplicate item:",
          filePath,
          // currentFileBundleContent,
          // conflictedContent,
        );
